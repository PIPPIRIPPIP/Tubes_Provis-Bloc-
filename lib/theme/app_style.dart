...
class AppStyle {
  static TextStyle txtPoppinsSemiBold32Black90001 = TextStyle(
  ...
  static TextStyle txtPoppinsSemiBold16Gray600 = TextStyle(
    color: ColorConstant.gray600,
    fontSize: getFontSize(
      16,
    ),
  ...
  static TextStyle txtPoppinsSemiBold11 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      11,
    ),
  ...
  static TextStyle txtPoppinsMedium12DeeporangeA700 = TextStyle(
  ...
  static TextStyle txtPoppinsSemiBold12WhiteA700 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtPoppinsRegular16BlueA200 = TextStyle(
    color: ColorConstant.blueA200,
    fontSize: getFontSize(
      16,
    ),
  ...
  static TextStyle txtPoppinsMedium12Green800 = TextStyle(
  ...
  static TextStyle txtPoppinsSemiBold16Black90001 = TextStyle(
    color: ColorConstant.black90001,
    fontSize: getFontSize(
      16,
    ),
  ...
  static TextStyle txtPoppinsRegular12Gray900 = TextStyle(
